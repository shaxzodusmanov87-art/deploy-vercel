...
const $$RSC_SERVER_ACTION_0 = async function updatePost($$ACTION_CLOSURE_BOUND, formData) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post.update({
        where: {
            id: $$ACTION_ARG_0
        },
        data: {
...
async function EditPost({ params }) {
    ...
    const post = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post.findUnique({
        where: {
            id: postId
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__753d3f96._.js.map